...
class ZipArchive extends AbstractSystemTest
{
    ...
    {
        return t('Для корректной работы обмена с 1С, загрузки фото из ZIP архивов, установки модулей из маркетплейса и многих других функций требуется наличие функции распаковки архивов.');
    }
