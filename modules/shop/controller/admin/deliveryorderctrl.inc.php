...
class DeliveryOrderCtrl extends Crud
{
    ...
    function helperIndex()
    {
        ...
        $helper->setTopHelp(t('Здесь отображаются заказы на доставку. Здесь вы можете фильтровать и массово удалять ненужные заказы на доставку. Массовое удаление заказов не производит операций на стороне сервиса доставки.'));
