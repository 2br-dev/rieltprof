    ...
    constructor(element) {
        ...
        this.owner.querySelectorAll(this.selector.pvzListItem).forEach((element) => {
            element.addEventListener('click', () => {
                let pointObject = this.pvzPoints[element.dataset.deliveryId][element.dataset.pvzCode];
                let geoObjectState = this.map.clusterer.getObjectState(pointObject);
                ...
                if (geoObjectState.isShown) {
                    ...
                    if (geoObjectState.isClustered) {
                        ...
                        this.map.clusterer.balloon.open(geoObjectState.cluster);
                    } else {
