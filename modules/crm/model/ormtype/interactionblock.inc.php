...
/**
 * Блок взаимодействий. Нужно размещать в отдельной вкладке ORM объекта
 */
class InteractionBlock extends UserTemplate
{
    protected
        $link_type,
        $only_exists;
    ...
    {
        $template = '%crm%/admin/ormtype/interactionblock.tpl';
