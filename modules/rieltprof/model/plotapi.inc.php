...
use Rieltprof\Model\Orm\Flat;
use Rieltprof\Model\Orm\House;
use Rieltprof\Model\Orm\Plot;
 ...
 */
class PlotApi extends EntityList
{
    ...
    {
        parent::__construct(new Plot(), array(
            'multisite' => true,
            'aliasField' => 'alias',
            'nameField' => 'title',
