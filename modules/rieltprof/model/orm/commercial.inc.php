 ...
 * --\--
 */
class Commercial extends OrmObject
{
    const MAX_RATING = 5;
...
//                'Checker' => array('chkEmpty', t('Укажите хотя бы одну категорию')),
    ...
    function beforeWrite($flag)
    {
        ...
        if($action == 'sale'){
            $this['title'] = $district .', '. $this['cost_product'] . 'р., ' . $this['rooms'] . 'ком. ' . $object;
        }
        if($action == 'rent'){
            $this['title'] = $district .', '. $this['cost_rent'] . 'p./мес., ' . $this['rooms'] . 'ком. ' . $object;
        }
...
//        $this->addProperty($config[''])
        ...
        if ($flag == self::INSERT_FLAG) {
            ...
            $this['controller'] = 'commercialctrl';
            $this['public'] = 1;
