...
//                'Checker' => array('chkEmpty', t('Укажите хотя бы одну категорию')),
    ...
    function beforeWrite($flag)
    {
        ...
        if($action == 'sale'){
            $this['title'] = $district .', '. $this['cost_product'] . 'р., ' . $this['land_area'] . 'сот. ' . $object;
        }
        if($action == 'rent'){
            $this['title'] = $district .', '. $this['cost_rent'] . 'p./мес., ' . $this['land_area'] . 'сот. ' . $object;
        }
        ...
        if($this['cost_product']){
            ...
            $this['cost_one'] = $this['cost_product'] / $this['land_area'];
