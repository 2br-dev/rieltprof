 ...
 * --\--
 */
class Garage extends OrmObject
{
    const MAX_RATING = 5;
...
//                'Checker' => array('chkEmpty', t('Укажите хотя бы одну категорию')),
    ...
    function beforeWrite($flag)
    {
        ...
        if($action == 'sale'){
            $this['title'] = $district .', '. $this['cost_product'] . 'р., ' . $this['square'] . 'кв.м. ' . $object;
        }
        if($action == 'rent'){
            $this['title'] = $district .', '. $this['cost_rent'] . 'p./мес., ' . $this['square'] . 'кв.м. ' . $object;
        }
