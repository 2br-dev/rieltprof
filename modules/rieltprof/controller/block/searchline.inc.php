...
class SearchLine extends StandartBlock
{
    ...
    protected $default_params = [
        ...
        'hideAutoComplete' => 0,
        'indexTemplate' => '%catalog%/blocks/searchline/searchform.tpl',
        'imageWidth' => 62,
        'imageHeight' => 62,
        'imageResizeType' => 'xy',
    ...
    /**@var \Rieltprof\Model\Api $rieltprof_api*/
    public $rieltprof_api;
    ...
    public function init()
    {
        ...
        $this->rieltprof_api = new \Rieltprof\Model\Api();
    ...
    public function actionAjaxSearchItems()
    {
        ...
        if (!empty($query)) {
            ...
            $this->rieltprof_api->prepareSearchQueryProduct($query, $this, $this->getParam('order_field'), $this->getParam('order_direction'));
            $list = $this->rieltprof_api->getSearchQueryProductResults($this->getParam('searchLimit'));
