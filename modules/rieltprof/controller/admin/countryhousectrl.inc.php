...
use RieltProf\Model\CountryHouseApi;
...
/**
 * Контроллер каталога Дома
 */
class CountryHouseCtrl extends Crud
{
    ...
    {
        parent::__construct(new CountryHouseApi());
    ...
    public function actionAdd($primaryKeyValue = null, $returnOnSuccess = false, $helper = null)
    {
        ...
        if ($primaryKeyValue <= 0) {
            ...
            $obj->fillOffers();
            $obj->fillOffersStock();
            $this->getHelper()->setTopTitle(t('Редактировать ') . '{title}');
        }
