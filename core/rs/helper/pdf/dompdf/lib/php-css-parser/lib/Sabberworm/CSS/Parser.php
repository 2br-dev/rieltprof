...
class Parser {
	...
	private function parseColorValue() {
		...
		if ($this->comes('#')) {
			...
			$aColor = ['r' => new Size(intval($sValue[0] . $sValue[1], 16), null, true, $this->iLineNo), 'g' => new Size(intval($sValue[2] . $sValue[3], 16), null, true, $this->iLineNo), 'b' => new Size(intval($sValue[4] . $sValue[5], 16), null, true, $this->iLineNo)];
		} else {
