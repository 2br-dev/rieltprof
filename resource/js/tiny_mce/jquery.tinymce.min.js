...
$('body').on('focusin', function(e) { //Специальная вставка, чтобы внутри диалгового окна jquery работало диалоговое оно TinyMCE
 ...
 * @private
 */
!function(){var f,c,u,p,d,s=[];d=window,p=d.jQuery;function v(){
